package com.learning.awscognito.config;

import com.learning.awscognito.exception.ResourceNotFoundException;
import java.net.URI;
...
public class GlobalExceptionHandler {
    ...
    ProblemDetail onException(Exception exception) {
        if (exception instanceof ResourceNotFoundException resourceNotFoundException) {
            ...
            problemDetail.setType(URI.create("http://api.aws-cognito-project.com/errors/not-found"));
