package com.learning.awslambda.config.logging;
...
public class LoggingAspect {
    ...
    @Pointcut("@within(com.learning.awslambda.config.logging.Loggable) || "
            + "@annotation(com.learning.awslambda.config.logging.Loggable)")
