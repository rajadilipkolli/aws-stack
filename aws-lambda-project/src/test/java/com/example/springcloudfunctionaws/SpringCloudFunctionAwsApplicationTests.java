...
class SpringCloudFunctionAwsApplicationTests {
    ...
    @Container
    static PostgreSQLContainer<?> postgres = new PostgreSQLContainer<>("postgres:16.1-alpine").withNetwork(network)
    ...
    void contextLoads() throws IOException {
        ...
        CreateFunctionUrlConfigRequest createFunctionUrlConfigRequest = CreateFunctionUrlConfigRequest.builder()
                ...
                .build();
        CreateFunctionUrlConfigResponse createFunctionUrlConfigResponse = lambdaClient.createFunctionUrlConfig(createFunctionUrlConfigRequest);
