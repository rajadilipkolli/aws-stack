package com.learning.awspring.config.logging;
...
public class LoggingAspect {
    ...
    @Pointcut(
            """
            @within(com.learning.awspring.config.logging.Loggable) || \
            @annotation(com.learning.awspring.config.logging.Loggable)\
            """)
