package com.learning.awssns.config.logging;
...
public class LoggingAspect {
    ...
    @Pointcut("@within(com.learning.awssns.config.logging.Loggable) || "
            + "@annotation(com.learning.awssns.config.logging.Loggable)")
